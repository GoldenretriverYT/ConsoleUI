...
namespace ConsoleUILib.Window
{
    public abstract class BaseWindow
    {
        ...
        public virtual void DrawWindow()
        {
            ...
            ConsoleCanvas.DrawRect(X, Y, Width, Height, ConsoleColor.Gray);
            ConsoleCanvas.DrawRect(X, Y, Width, 1, ConsoleColor.DarkGray);
            ConsoleCanvas.DrawString(Title, X, Y, Width, 1, ConsoleColor.White, ConsoleColor.DarkGray);
        }
    }
}
